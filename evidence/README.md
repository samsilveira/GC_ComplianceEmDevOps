...
| `EVID-04` | Qualidade e auditoria de dependências | Relatórios JSON do Ruff e pip-audit | [Registro completo](EVID-04.md) / [execução verde](https://github.com/samsilveira/GC_ComplianceEmDevOps/actions/runs/31968978387) / [PR #18](https://github.com/samsilveira/GC_ComplianceEmDevOps/pull/18) — commit `13fea95` | Manoel (P3) |
