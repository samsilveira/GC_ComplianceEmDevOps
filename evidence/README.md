...
| `EVID-03` | Bloqueio por detecção de segredos | Log do Gitleaks (falha controlada) | [Registro em preparacao](EVID-03.md) | Manoel (P3) |
| `EVID-04` | Qualidade e auditoria de dependências | [Relatórios do Ruff e pip-audit](EVID-04.md) | Manoel (P3) |
