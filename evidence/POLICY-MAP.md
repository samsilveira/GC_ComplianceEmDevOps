...
| Release versionada (`POL-06`) | changelog, tag anotada e GitHub Release | [EVID-06](EVID-06.md) | Não se aplica à release aprovada | A correção exige nova versão SemVer; tags publicadas não são movidas |
| Evidências por execução (`POL-07`) | logs, artefatos e registros permanentes | [EVID-01](EVID-01.md) a [EVID-06](EVID-06.md) | Runs vermelhos em [EVID-02](EVID-02.md), [EVID-03](EVID-03.md) e [EVID-05](EVID-05.md) | Runs verdes correspondentes e pipeline da tag em [EVID-06](EVID-06.md) |
